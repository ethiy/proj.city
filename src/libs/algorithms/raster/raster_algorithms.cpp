...
namespace urban
{
    projection::RasterPrint rasterize(projection::FootPrint const& brick_projection, double const& pixel_size, shadow::Point const& pivot, unsigned short const& epsg_code)
    {
